...
try
{
	...
	stmt = conn.createStatement();
	 ...
	 for(int pageNum=1; pageNum<=5; pageNum++)
	 {
	     ...
	     String url = "http://iq.ifac.or.kr/openAPI/real/search.php?svID=festival&apiKey=HTX1w9mYcVsy4WJN6P2gK3Ar8BtlSb&resultType=xml&pSize=20&cPage=";
	     url+= pageNum;
		 ...
		 int n=0;
	     String node[] = {"idx", "title", "link", "gubun", "organ", "syear", "period", "tel", "description", "pubDate"};
		 String nodeName = "";
	     ...
	     for(int i=0; i<length; i++) {
	         ...
	         query = "insert into festival values( ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
			 pstmt = conn.prepareStatement(query);
			 for(n=1; n<=10;n++) pstmt.setString(n,tmp[n-1]);
			 pstmt.executeUpdate();
			 n=0;
	     }
	 }
